...
d_identity = np.vectorize(output_layer_activation_derivative)
...
class NeuralNetwork():
    ...
    def __init__(self):
        ...
        self.training_points = [((-5, -8), -13), ((1, -2), -1), ((-3, -3), -6), ((-1, 3), 2), ((-6, -3), -9),
                                ((-9, -10), -19),
                                ((-7, -6), -13), ((9, 5), 14), ((1, -1), 0), ((8, -9), -1)]
    ...
    def train(self, x1, x2, y):
        ...
        # Compute gradients
        output_layer_error = np.multiply((y - activated_output), -1 * d_identity(activated_output))
        hidden_layer_error = np.multiply((self.hidden_to_output_weights.T @ output_layer_error),
                                         d_relu(hidden_layer_activation))
        ...
        print(1 / 2 * (y - activated_output) ** 2)
